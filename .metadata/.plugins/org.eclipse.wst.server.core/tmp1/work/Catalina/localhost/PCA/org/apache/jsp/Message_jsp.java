 ...
 * Generated at: 2021-03-14 06:36:52 UTC
...
public final class Message_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("bean.Message_bean");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	-------------------------------------------------------------------------------------------------*/
      ...
      out.write("\r\n");
      out.write("\t<div class=\"Massage_whole_block\">\r\n");
      out.write("\t\t<div class=\"Massage_leftblock\">\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "message_menu.jsp", out, false);
      out.write("\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"Message_head\" style=\"margin-top: 45px;\" class=\"small-tittle middle-font font-normal-color\">\r\n");
      out.write("\t\t\t\t&nbsp;┃&nbsp;公共聊天室\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<iframe style=\"width: 100%; height: 630px; border: 0px solid white;\" src=\"chat_room.jsp\"></iframe>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"Massage_rightblock\">\r\n");
      out.write("\t\t\t<iframe src=\"official.jsp\" width=\"100%\" height=\"100%\" scrolling=\"no\" frameborder=\"0\"> </iframe>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
      ...
      out.write("\t\t\t\t\t\tfunction() {\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t$(this).removeClass(\"message_Office\");\r\n");
      out.write("\t\t\t\t\t\t\t$(this).addClass(\"message_Office_v dark-color\");\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_Work_v').addClass('message_Work');\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_Work').removeClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'message_Wok_v dark-color');\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_tips_v').addClass(\"message_tips\");\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_tips').removeClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'message_tips_v dark-color');\r\n");
      out.write("\t\t\t\t\t\t\t$('.Massage_rightblock')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t'<iframe src=\"official.jsp\" width=\"100%\" height=\"100%\" scrolling=\"no\" frameborder=\"0\"> </iframe>');\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t$('.message_Work')\r\n");
      out.write("\t\t\t\t.click(\r\n");
      out.write("\t\t\t\t\t\tfunction() {\r\n");
      out.write("\t\t\t\t\t\t\t$(this).removeClass(\"message_Work\");\r\n");
      out.write("\t\t\t\t\t\t\t$(this).addClass(\"message_Work_v dark-color\");\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_Office_v').addClass(\"message_Office\");\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_Office').removeClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'message_Office_v dark-color');\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_tips_v').addClass(\"message_tips\");\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_tips').removeClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'message_tips_v dark-color');\r\n");
      out.write("\t\t\t\t\t\t\t$('.Massage_rightblock')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t'<iframe src=\"Work_tips.jsp\" width=\"100%\" height=\"100%\" scrolling=\"no\" frameborder=\"0\"> </iframe>');\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t$('.message_tips')\r\n");
      out.write("\t\t\t\t.click(\r\n");
      out.write("\t\t\t\t\t\tfunction() {\r\n");
      out.write("\t\t\t\t\t\t\t$(this).removeClass(\"message_tips\");\r\n");
      out.write("\t\t\t\t\t\t\t$(this).addClass(\"message_tips_v dark-color\");\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_Office_v').addClass(\"message_Office\");\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_Office').removeClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'message_Office_v dark-color');\r\n");
      out.write("\t\t\t\t\t\t\t$('.message_Work_v').addClass('message_Work');\r\n");
      ...
      out.write("\t\t\t\t\t\t\t$('.Massage_rightblock')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t'<iframe src=\"message_tips.jsp\" width=\"100%\" height=\"100%\" scrolling=\"no\" frameborder=\"0\"> </iframe>');\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
