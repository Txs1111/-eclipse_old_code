 ...
 * Generated at: 2021-03-19 09:36:24 UTC
...
public final class source_005fteam_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link\r\n");
      out.write("\thref=\"https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/3.0.1/css/bootstrap.min.css\"\r\n");
	...
	if (title != null && !title.equals(null) && title != "" && content != null && !content.equals(null)
      ...
      out.write("\r\n");
      out.write("\t<div\r\n");
      out.write("\t\tstyle=\"width: 87.5%; height: 824px; margin-left: 0.1%; float: left;\"\r\n");
      out.write("\t\tclass=\"dinylight-color\">\r\n");
      out.write("\t\t<div class=\"container\">\r\n");
      out.write("\t\t\t<div class=\"row clearfix\">\r\n");
      out.write("\t\t\t\t<div class=\"col-md-12 column\">\r\n");
      out.write("\t\t\t\t\t<div class=\"jumbotron\">\r\n");
      out.write("\t\t\t\t\t\t<h1>上传资源</h1>\r\n");
      out.write("\t\t\t\t\t\t<p>In order to make our website have better development,\r\n");
      out.write("\t\t\t\t\t\t\tplease upload more resources.</p>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"row clearfix\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-12 column\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\taction=\"source_team.jsp\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"inputEmail3\" class=\"col-sm-2 control-label\">Title:</label></label>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"inputPassword3\" class=\"col-sm-2 control-label\">Content:</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"content\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"inputPassword3\" required rows=\"15\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-4 column\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"btn-group\" style=\"width: 49%;\">\r\n");
      ...
      out.print(gr.type_daihao.get(i));
      out.write('"');
      out.write('>');
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"btn-group\" style=\"width: 49%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" name=\"path\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tstyle=\"display: flex; justify-content: center;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"");
      out.print(gr.path_daihao.get(i));
      out.write('"');
      out.write('>');
      out.print(gr.allpath.get(i));
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\tclass=\"btn btn-default btn-block active btn-success\" value=\"提交\" />\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
