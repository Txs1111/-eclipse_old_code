...
<body>
	<div class="small-tittle middle-font font-normal-color" align="center">&nbsp;-&nbsp;用户角色管理&nbsp;-&nbsp;</div>
	...
	<%
		...
		if (showpower == null || "0".equals(showpower)) {
			...
			showpage = "change_user_role_detail.jsp";
		}
	%>
	<div style="float: left; width: 40%; height: 590px; overflow-y: auto;">
		...
		<form action="change_user_role.jsp" method="post">
