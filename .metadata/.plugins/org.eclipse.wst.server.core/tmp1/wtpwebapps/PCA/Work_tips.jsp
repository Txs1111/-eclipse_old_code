...
<body>
    ...
    %>
    <div id="Message">
		<div id="Message_head" class="small-tittle middle-font font-normal-color">&nbsp;┃&nbsp;作业提醒
	     ...
	     if(num>3){
		  ...
		  for(int i = 0;i<num;i++){			 
			  //判断是否显示若为空则不显示
				  ...
				  %>
				     <div id="tidings" style="height:210px; border-bottom: none;">
						<div id="tidings_left">
							<div id="img">
							...
							<div id="name">
								<font class="small-font" id="samll-B"><%=st.nextToken() %></font><br />
								<%st.nextToken(); %>
								 <a>
						...
						<div id="tidings_right">
							<div class="dynamic_content_new dinylight-color"
								style="border-radius: 1px; height:80px;"><textarea style="width:100%;height:100%;border:0px solid white;"><%=st.nextToken() %></textarea>
							</div>
							<div id="function" style="border-bottom: 1px solid gainsboro;">
								<div id="time">
								...
								<div id="like" style="display:none;">
									<img src="img/example/收藏.png" id="good"> <font id="samll">22</font>
								</div>							</div>
						</div>
					</div>	
		...
		%>
		<form action="Work_tips.jsp"method="post">
		...
		<%
				  ...
				  %><div id="tidings" class="small-font" style="text-align: center; line-height: 200px; border-bottom: 0; color: gainsboro;"><font>您暂无作业消息</font></div><% 
			  }
	    %>		
	</div>
</body>
