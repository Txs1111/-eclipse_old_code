...
if(request.getParameter("car_number")!=null){
	...
	car_number=URLDecoder.decode(car_number, "utf-8");
}
    ...
    <table width="100%"  class="table" >
      <tr>
       ...
       <%if(car_number==null) {%>  
        ...
        <td width="10%">发货客户：</td>
        <td width="40%" bgcolor="#FFFFFF"><s:select name="customer_id" list="#request.customerList" listKey="customer_id" listValue="customer_user"/></td>
      </tr>
      <tr>
      ...
      <tr>
		...
		<s:property value="#request.goodsSuccess" escapeHtml="false"/>
