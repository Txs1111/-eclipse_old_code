...
<body>
    ...
    <div id="Message">
		...
		%>
		<form action="official.jsp"method="post">
		...
		<%
				  ...
				  %><div id="tidings" class="small-font" style="text-align: center; line-height: 200px; border-bottom: 0; color: gainsboro;"><font>您暂无官方消息</font></div><% 
			  }
	    %>		
	</div>
</body>
